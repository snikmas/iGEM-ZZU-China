...
import cooperationFigure1_1 from '../../assets/images/collaborations/collaborationFigure1_1.png';
import cooperationFigure1_2 from '../../assets/images/collaborations/collaborationFigure1_2.png';
import cooperationFigure1_3 from '../../assets/images/collaborations/collaborationFigure1_3.png';
import cooperationFigure1_4 from '../../assets/images/collaborations/collaborationFigure1_4.png';
import cooperationFigure1_5 from '../../assets/images/collaborations/collaborationFigure1_5.png';

import cooperationFigure2_1 from '../../assets/images/collaborations/collaborationFigure2_1.png';
import cooperationFigure2_2 from '../../assets/images/collaborations/collaborationFigure2_2.png';
import cooperationFigure2_3 from '../../assets/images/collaborations/collaborationFigure2_3.png';
import cooperationFigure2_4 from '../../assets/images/collaborations/collaborationFigure2_4.png';
import cooperationFigure2_5 from '../../assets/images/collaborations/collaborationFigure2_5.png';
import cooperationFigure2_6 from '../../assets/images/collaborations/collaborationFigure2_6.png';
import cooperationFigure2_7 from '../../assets/images/collaborations/collaborationFigure2_7.png';

import cooperationFigure3_1 from '../../assets/images/collaborations/collaborationFigure3_1.png';
import cooperationFigure3_2 from '../../assets/images/collaborations/collaborationFigure3_2.png';
import cooperationFigure3_3 from '../../assets/images/collaborations/collaborationFigure3_3.png';
import cooperationFigure3_4 from '../../assets/images/collaborations/collaborationFigure3_4.png';
import cooperationFigure3_5 from '../../assets/images/collaborations/collaborationFigure3_5.png';
import cooperationFigure3_6 from '../../assets/images/collaborations/collaborationFigure3_6.png';
import cooperationFigure3_7 from '../../assets/images/collaborations/collaborationFigure3_7.png';
import cooperationFigure3_8 from '../../assets/images/collaborations/collaborationFigure3_8.png';
  ...
  <>
    ...
    <div id="overview" className="view-content">
      <div className="content-header">
        <div className="h1">Collaborations</div>
      </div>
    ...
    <div className="content-header">
      ...
      <section id="japan-online" className="education-section">
        ...
        <div className="content-body">
            ...
            <div className="figure-container">
              <img src={cooperationFigure1_1} alt="Team-to-Team Technical Exchange" className="figure-image" />
              <div className="h4">Figure 1. Japan Online Exchange</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="osaka-university" className="education-section">
        <div className="education-section-content">
          ...
          <div className="content-body">
            ...
            <div className="figure-container">
              <img src={cooperationFigure1_2} alt="Osaka University On-Site Exchange" className="figure-image" />
              <div className="h4">Figure 2. Osaka University On-Site Exchange</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="taian-igem" className="education-section">
        <div className="education-section-content">
          ...
          <div className="content-body">
            ...
            <div className="figure-container">
              <img src={cooperationFigure1_3} alt="Taian iGEM Exchange Conference" className="figure-image" />
              <div className="h4">Figure 3. Taian iGEM Exchange Conference</div>
            </div>
          </div>
            </div>
      </section>
      ...
      <section id="shanhe-igem" className="education-section">
        <div className="education-section-content">
          ...
          <div className="content-body">
            ...
            <div className="figure-container">
              <img src={cooperationFigure1_4} alt="Shanhe Four Provinces iGEM Exchange Conference" className="figure-image" />
              <div className="h4">Figure 4. Shanhe Four Provinces iGEM Exchange Conference</div>
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="education-section-content">
        ...
        <div className="content-body">
            ...
            <div className="figure-container">
              <img src={cooperationFigure1_5} alt="The 10th China Synthetic Biology Conference (CCiC) & Synbiopunk 2025" className="figure-image" />
              <div className="h4">Figure 5. The 10th China Synthetic Biology Conference (CCiC) & Synbiopunk 2025</div>
            </div>
          </div>
        </div>
      </section>
    ...
    <div id="educational-outreach" className="view-content">
      ...
      <div className="education-section-content">
        ...
        <div className="content-body">
            ...
            <div className="figure-container">
              <img src={cooperationFigure2_1} alt="" className="figure-image" />
            </div>
            <div className="figure-container">
              <img src={cooperationFigure2_2} alt="" className="figure-image" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="womens-day-campus" className="education-section">
        <div className="education-section-content">
          ...
          <div className="content-body">
            ...
            <div className="figure-container">
              <img src={cooperationFigure2_3} alt="" className="figure-image" />
            </div>
            <div className="figure-container">
              <img src={cooperationFigure2_4} alt="" className="figure-image" />
            </div>
            <div className="figure-container">
              <img src={cooperationFigure2_5} alt="" className="figure-image" />
            </div>
          </div>
        </div>
      </section>

      ...
      <section id="primary-education" className="education-section">
        <div className="education-section-content">
          ...
          <div className="content-body">
            ...
            <p>On May 30, 2025, we visited Zhengzhou University Experimental Primary School and carried out a hands-on DNA extraction experiment with fifth-grade students. The goal was to let children not only hear about DNA <strong>but actually see it with their own eyes</strong>, planting the first seeds of scientific exploration. Divided into nine groups, the students followed step-by-step instructions: mashing strawberries, adding salt and detergent to break cell walls, filtering the mixture, and finally adding chilled alcohol to precipitate DNA.</p>
            <p>At every stage, team members patiently explained the science behind each step. When the <strong>white, filament-like DNA appeared</strong>, the classroom was filled with excited exclamations. One student said, "I didn't know something so small in our bodies could really be seen like this—it's like magic!" Teachers observed that the activity <strong>successfully combined rigor and fun</strong>, and they praised it as "a perfect example of learning by doing."</p>
            <p>To reinforce the lesson, we distributed instruction cards and QR codes linking to a video tutorial. Follow-up surveys showed that <strong>most students could clearly recall the three main steps</strong>, and many expressed interest in learning more about synthetic biology. Inspired by their enthusiasm, we proposed a long-term "Little Science Talent" program with the school, aiming to provide children with sustained opportunities for scientific exploration.</p>
            ...
            <p>In another session, we introduced DNA through a question closely connected to the children's daily lives: <strong>"Why do some people dislike cilantro?"</strong> This simple question immediately caught their attention and provided a natural entry point to discuss genetic differences. We explained DNA not with complex terminology but through vivid metaphors—base pairs as "zippers" and the double helix as a "spiral staircase."</p>
            <p>The children were deeply engaged, eagerly raising imaginative questions such as, <strong>"If I fall down, will my little spiral staircase break?"</strong> Their innocent curiosity made the classroom lively and interactive. Teachers later commented that this workshop was "a creative way to make abstract science relatable to children's everyday experiences."</p>
            <p>By the end of the session, students had not only learned about DNA but also realized that <strong>science could explain many aspects of daily life</strong>. The workshop helped nurture their courage to <strong>ask questions and fostered a spirit of active exploration.</strong></p>
            ...
            <p>For younger children aged 4–12, we organized a multi-activity outreach program that blended <strong>observation, experimentation, and parent-child engagement</strong>. Younger participants visited the zebrafish facility, where they were fascinated by the sight of transparent embryos and swimming larvae. Volunteers helped each child adjust microscopes to view tiny details of the fish, prompting gasps of wonder. Older students explored cell biology, observing onion root tip cell division under the microscope, while attending short lectures tailored to their level.</p>
            <p>Parents were invited to join for a photo session against a genetics-themed backdrop, turning the outreach into a <strong>family science day</strong>. Teachers highlighted the program's inclusiveness, noting that "every child, regardless of age, had a chance to feel like a scientist."</p>
            <p>From these activities, we witnessed firsthand the power of direct interaction: children who had never touched a microscope before left with sparkling eyes and new questions. One parent told us, "My child used to think science was difficult, but now she says she wants to look at more things under the microscope at home." For our team, this was not only a chance to inspire but also an opportunity to <strong>refine our science communication</strong>, learning how to make complex concepts accessible while keeping the joy of discovery alive.</p>
      ...
      <section id="middle-school-education" className="education-section">
        <div className="education-section-content">
          ...
          <div className="content-body">
            ...
            <p>The classroom atmosphere was lively and full of questions. One student asked, <strong>"If the lysis buffer can break down the cell wall, will it also destroy the plasmid?"</strong> Such interactions showed real engagement and pushed us to refine our explanations. Teachers praised the activity as age-appropriate and imaginative, while students expressed a strong sense of achievement. As one remarked, "I never thought I could do an experiment like real scientists. It feels like I've unlocked a new world."</p>
            <p>By combining <strong>storytelling with hands-on practice</strong>, the "Science Courier" model not only conveyed the logic of plasmid extraction but also <strong>lowered cognitive barriers</strong>, helping students experience the excitement of life science in a way that was both accessible and inspiring.</p>
      ...
      <section id="high-school-education" className="education-section">
        <div className="education-section-content">
          ...
          <div className="content-body">
            ...
            <p>Feedback was overwhelmingly positive. One student said, "It didn't feel like a lecture at all — it felt like talking to older siblings who had already walked the path we're about to take." Teachers praised the <strong>practical, relatable guidance</strong>. For our team, the event revealed students' genuine interests and knowledge gaps, helping tailor future outreach. Most importantly, it broke down barriers between "scientists" and students, inspiring them to see themselves as future innovators.</p>
            ...
            <div className="h3">Visit to the Life Science Museum – Connecting Biology to Medicine</div>
            <p>To bridge classroom learning with real-world application, we organized a visit to the Life Science Museum, transforming abstract biological knowledge into a vivid, multidimensional experience. The activity aimed to show how <strong>biology and synthetic biology</strong> underpin modern medicine while cultivating <strong>empathy, responsibility, and a sense of purpose</strong> in future scientists or medical professionals.</p>
            <p>Guided by our team members, students explored four themed zones. In the “Nine Major Systems of the Human Body” section, they examined anatomical models and interactive displays to understand physiological structures and related diseases. The “Disease Treatment and First Aid” zone offered hands-on practice in emergency response, providing <strong>practical skills beyond textbooks</strong>. The “Medical Humanistic Spirit” section encouraged reflection on real stories of medical professionals, highlighting <strong>ethical and emotional aspects of healthcare</strong>. Finally, the “History of Medical Education” exhibit traced key scientific milestones, deepening students’ appreciation for the progress of synthetic biology and medical science.</p>
            ...
            <p>Feedback from students was highly positive. Many reported a <strong>change in how they viewed biology</strong>, recognizing it not just as exam material but as a tool for understanding and improving human life. One participant reflected, “Seeing how biology and synthetic biology connect to medicine made me realize that <strong>science isn’t just knowledge—it’s responsibility</strong>.” The visit demonstrated the importance of hands-on, immersive science education in inspiring students and guiding them toward careers in <strong>research, medicine, and beyond</strong>.</p>

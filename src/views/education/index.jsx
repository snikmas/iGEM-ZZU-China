  ...
  <>
    ...
    <div id="overview-education" className="view-content">
      ...
      <div className="content-body">
        ...
        <p>
        Education has always been a cornerstone of our iGEM journey—not only a responsibility to the public, but also a bridge connecting science with daily life. This year, our project focuses on breast cancer, a disease where early screening, diagnosis, and treatment can make the difference between life and death. Guided by this theme, we designed diverse initiatives ranging from “Biology for Kids” workshops and school experiments to Anatomy Hall visits and the Little Scientist Program, allowing participants of different ages to experience science firsthand.
        </p>
        <p>
        Rather than simply “delivering knowledge,” our approach emphasized interaction, participation, and feedback. Through community roadshows, online education platforms, and health campaigns, we reached wider audiences; through Doctors’ Dialogue, Arena of Knowledge contests, and the Turtle Soup Game, we deepened understanding in engaging and interactive ways. Meanwhile, Humanistic Spirit sessions highlighted medical humanities and female scientist role models, while Empowerment activities encouraged breast self-exams and proactive health choices. To sustain these efforts, we promoted resources sharing under the belief that “Your Health, Your Choice” should be accessible to all.
        </p>
        <p>

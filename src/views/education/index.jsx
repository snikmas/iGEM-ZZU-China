      ...
      <section id="high-school-education" className="education-section">
        <div className="education-section-content">
          ...
          <div className="content-body">
            ...
            <p>To bridge classroom learning with real-world application, we organized a visit to the Life Science Museum, transforming abstract biological knowledge into a vivid, multidimensional experience. The activity aimed to show how <strong>biology and synthetic biology</strong> underpin modern medicine while cultivating empathy, responsibility, and a sense of purpose in future scientists or medical professionals.</p>
            <p>Guided by our team members, students explored four themed zones. In the “Nine Major Systems of the Human Body” section, they examined anatomical models and interactive displays to understand physiological structures and related diseases. The “Disease Treatment and First Aid” zone offered hands-on practice in emergency response, providing practical skills beyond textbooks. The “Medical Humanistic Spirit” section encouraged reflection on real stories of medical professionals, highlighting ethical and emotional aspects of healthcare. Finally, the “History of Medical Education” exhibit traced key scientific milestones, deepening students’ appreciation for the progress of synthetic biology and medical science.</p>

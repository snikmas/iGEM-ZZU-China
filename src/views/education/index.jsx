      ...
      <section id="high-school-education" className="education-section">
        <div className="education-section-content">
          ...
          <div className="content-body">
            ...
            <p>To bridge classroom learning with real-world application, we organized a visit to the Life Science Museum, transforming abstract biological knowledge into a vivid, multidimensional experience. The activity aimed to show how <span className="text-red">biology and synthetic biology</span> underpin modern medicine while cultivating empathy, responsibility, and a sense of purpose in future scientists or medical professionals.</p>

...
// Engineering相关图片导入
import engineeringFigure1 from '../../assets/images/engineering/Figure1.png';
import engineeringFigure2 from '../../assets/images/engineering/Figure2.png';
import engineeringFigure3 from '../../assets/images/engineering/Figure3.png';
  ...
  <>
    ...
    <div id="lab" className="view-content">
      ...
      <div className="content-body">
        ...
        <section id="cd63-aptamer-beads" className="education-section">
          <div className="education-section-content">
            ...
            <div className="content-body">
              ...
              <div className="h3">Iteration 1: Optimization of aptamer coating temperature</div>
              ...
              <div className="h3">Iteration 2: Optimization of aptamer coating time</div>
              ...
              <div className="h3">Iteration 3: Optimization of exosome capture temperature</div>
              ...
              <div className="h3">Iteration 4: Optimization of exosome capture time</div>
        ...
        {/* Cas14a Prokaryotic Expression Cycle */}
        ...
        <section id="hcr-amplification" className="education-section">
          <div className="education-section-content">
            ...
            <div className="content-body">
              ...
              <div className="h3">Iteration 1: TH1/TH2 Concentration Optimization</div>
              ...
              <div className="h3">Iteration 2: HCR Reaction Time Optimization</div>
              ...
              <div className="h3">Iteration 3: HCR Reaction Temperature Optimization</div>
        ...
        <section id="apt-crispr-system" className="education-section">
          <div className="education-section-content">
            ...
            <div className="content-body">
              ...
              <div className="h3">Iteration 1 | Foundational APT-CRISPR/Cas12a System</div>
              ...
              <div className="h3">Iteration 2 | HCR Signal Amplification Integration</div>
              ...
              <div className="h3">Iteration 3 | Cas14a Enzymatic Upgrade</div>
              ...
              <div className="h3">Iteration 4 | RCA-Cas14a Dual Amplification</div>
    ...
    <div id="integrated-human-practices" className="view-content">
      ...
      <div className="content-body">
        ...
        <section id="ihp-iteration1" className="education-section">
          <div className="education-section-content">
            <div className="content-section-header">
              <div className="h2">Iteration 1｜Enhancing Public Awareness of Male Breast Cancer</div>
            </div>
            <div className="content-body">
        ...
        <section id="ihp-iteration2" className="education-section">
          <div className="education-section-content">
            <div className="content-section-header">
              <div className="h2">Iteration 2｜Optimization of the Detection System Based on Stakeholder Feedback</div>
            </div>
            <div className="content-body">
              <div className="h3">Design</div>
              <p>
        ...
        <section id="ihp-iteration3" className="education-section">
          <div className="education-section-content">
            <div className="content-section-header">
              <div className="h2">Iteration 3｜Refinement of Public Science Communication Strategies</div>
            </div>
            <div className="content-body">
              <div className="h3">Design</div>
              <p>
        ...
        <section id="ihp-iteration4" className="education-section">
          <div className="education-section-content">
            <div className="content-section-header">
              <div className="h2">Iteration 4｜Construction of the Iterative Symbiotic Practice Model (ISPM)</div>
            </div>
            <div className="content-body">
              <div className="h3">Design</div>
              <p>

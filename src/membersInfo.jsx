...
const members = {
  member_01: {
    ...
    specificTasks: [
      {
        taskName: "Overall Leadership",
        description: "Took overall responsibility for the project, determining the project direction and goals. Led the team to make important decisions and ensured the project's scientific and innovative nature."
      },
      {
        taskName: "Strategic Planning",
        description: "Formulated the project's long-term development strategy and phase plans. Made sure the project was in line with academic frontiers and practical application needs."
      },
      {
        taskName: "External Cooperation",
        description: "Responsible for external communication and cooperation of the project, connecting with sponsors, academic institutions, etc. Expanded the project's influence and resource channels to provide support for project development."
      }
    ]
  },
  member_02: {
    ...
    specificTasks: [
      {
        taskName: "Research Direction Guidance",
        description: "Deeply involved in the project's research direction, providing professional guidance and cutting-edge insights. Helped the team break through technical bottlenecks and explore new research ideas."
      },
      {
        taskName: "Technical Innovation Promotion",
        description: "Encouraged and supported team members to carry out technical innovation, promoting the application of new technologies and methods in the project. Improved the project's technical level and competitiveness."
      },
      {
        taskName: "Team Training",
        description: "Organized academic exchanges and training activities to enhance team members' professional skills and academic literacy. Built a high-quality research team to lay a foundation for project success."
      }
    ]
  },
  member_03: {
    ...
    specificTasks: [
      {
        taskName: "Technical Guidance",
        description: "Provided in-depth support on technical aspects of the project, offering detailed advice on experimental techniques and software development. Assisted team members in optimizing experimental protocols and software algorithms to enhance overall project quality."
      },
      {
        taskName: "Project Supervision",
        description: "Regularly monitored project progress, promptly identifying potential risks and issues. Proposed corrective measures and adjustments to ensure the project stayed on track."
      },
      {
        taskName: "Experimental Support",
        description: "Delivered strong backing in experimental design and technical operations, guiding team members in standardizing experimental procedures and data collection. Assisted in troubleshooting and optimizing protocols to improve the reliability of experimental results."
      }
    ]
  },
  member_04: {
    ...
    specificTasks: [
      {
        taskName: "Guidance",
        description: "Provided professional insights and directions for the overall project, especially in the experimental design and theoretical analysis aspects. Offered advice to help team members overcome technical difficulties and make scientific decisions."
      },
      {
        taskName: "Coordination",
        description: "Coordinated internal team resources and external communication, ensuring smooth cooperation among different task groups. Helped connect relevant parties to promote the progress of the project."
      },
      {
        taskName: "Support",
        description: "Gave moral and academic support to team members, boosting their confidence and enthusiasm. Assisted in solving problems encountered in the project implementation process, creating a good research environment."
      }
    ]
  },
  member_05: {
    ...
    specificTasks: [
      {
        taskName: "Academic Consultation",
        description: "Offered professional academic advice in aspects like project design and result analysis. Helped team members expand their academic thinking and improve the scientific nature of the project."
      },
      {
        taskName: "Team Building",
        description: "Focused on team cohesion, organizing team-building activities to enhance communication and cooperation among members. Helped resolve conflicts within the team and create a positive working atmosphere."
      },
      {
        taskName: "Quality Control",
        description: "Conducted quality inspection on project outputs such as experimental data and report writing. Put forward improvement suggestions to ensure the project met high-standard requirements."
      }
    ]
  },
  member_06: {
    ...
    specificTasks: [
      {
        taskName: "Academic Guidance",
        description: "Provided expert advice on project direction and methodology, assisting the team in developing scientifically rigorous and innovative research plans. Helped students deepen their understanding of medical-biological integration and strengthen the theoretical foundation of the project."
      },
      {
        taskName: "Experimental Support",
        description: "Supported the team in refining experimental protocols and troubleshooting technical issues. Provided resources and insights to ensure experiments were conducted efficiently and aligned with project goals."
      },
      {
        taskName: "Research Integrity Assurance",
        description: "Conducted comprehensive reviews of project outputs, including data accuracy and report logic. Provided detailed suggestions for refinement to ensure all deliverables met high academic and ethical standards."
      }
    ]
  },
  member_07: {
    ...
    specificTasks: [
      {
        taskName: "Wiki Coding",
        description: "Responsible for the software engineering part of the wiki. Spent time writing, revising, and perfecting relevant content to ensure the description was accurate and comprehensive. Collaborated with team members to optimize the wiki page."
      },
      {
        taskName: "Investigation",
        description: "Participated in the protein marker CRISPR detection experiment. Carried out experimental operations, recorded data, and solved problems in the experiment process to ensure the smooth progress of the experiment."
      },
      {
        taskName: "Public Engagement",
        description: "Prepared for the CCIC exchange meeting, including agenda planning, material preparation, etc. Contacted various teams, organized exchange meetings, promoted information sharing and cooperation among teams, and enhanced project communication and collaboration."
      }
    ]
  },
  member_08: {
    ...
    specificTasks: [
      {
        taskName: "Conceptualization",
        description: "Responsible for proposing the project's core ideas, designing the overall framework based on breast cancer detection needs, and determining the application of Apt-HCR/RCA CRISPR-cas14 technology."
      },
      {
        taskName: "Project Administration",
        description: "Responsible for coordinating the project process, managing team operations, organizing human practice activities such as conferences and exhibitions, and ensuring the smooth progress of each project link."
      },
      {
        taskName: "Investigation",
        description: "Responsible for designing and completing experiments, formulating scientific and reasonable experimental schemes. Considered various factors to ensure the feasibility and effectiveness of experiments, and provided a basis for project research."
      },
      {
        taskName: "Software",
        description: "Completed the establishment of the software model part, designed and developed software models according to project needs. Conducted model optimization and verification to ensure the model could support project research and application."
      }
    ]
  },
  member_09: {
    ...
    specificTasks: [
      {
        taskName: "Entrepreneurship",
        description: "Responsible for writing the business plan of the project. Conducted market research, analyzed project commercial potential and development prospects. Formulated business strategies, including marketing, operation management, etc., to provide a commercial operation plan for the project."
      },
      {
        taskName: "Human Practice",
        description: "Carried out human practice work, including social investigation, public communication, etc. Understood social needs, promoted the combination of the project with society, and enhanced the project's social value."
      }
    ]
  },
  member_10: {
    ...
    specificTasks: [
      {
        taskName: "Investigation",
        description: "Participated in project data collection work, collecting and organizing data from various aspects such as experiments and investigations. Ensured data accuracy and completeness to provide support for project analysis."
      },
      {
        taskName: "Writing",
        description: "Responsible for project document management, including sorting out experimental reports, meeting minutes, etc. Classified and archived documents to ensure information was traceable and easy to retrieve."
      },
      {
        taskName: "Data Curation",
        description: "Participated in project data collection work, collecting and organizing data from various aspects such as experiments and investigations. Ensured data accuracy and completeness to provide support for project analysis."
      }
    ]
  },
  member_11: {
    ...
    specificTasks: [
      {
        taskName: "Safety",
        description: "Responsible for formulating protocols and measures to ensure wet experiment safety. Conducted safety inspections, trained team members on safety knowledge, and prevented safety accidents in the laboratory."
      },
      {
        taskName: "Background Research",
        description: "Defined the ethical guidelines to be followed during the project. Conducted ethical reviews on project activities to ensure the project complied with ethical norms and social responsibilities. Also participated in the wet experiment group, carrying out relevant experimental operations."
      }
    ]
  },
  member_12: {
    ...
    specificTasks: [
      {
        taskName: "Investigation",
        description: "Responsible for developing wet experiment methods, researching and exploring experimental techniques. Optimized experimental processes, improved experimental efficiency and accuracy, and provided technical support for project experiments."
      },
      {
        taskName: "Record Keeping",
        description: "Maintained detailed records of experimental procedures and results, ensuring traceability and organization of project data to support reproducibility and analysis."
      }
    ]
  },
  member_13: {
    ...
    specificTasks: [
      ...
      {
        taskName: "Investigation",
        description: "Participated in wet experiments, specifically responsible for the CD63 aptamer pull-down exosome experiment. Conducted experimental operations, analyzed data, and contributed to experimental research."
      },
      {
        taskName: "Visualization",
        description: "Responsible for Logo and team uniform design. Created creative and representative designs to enhance the team's image and cohesion."
      }
    ]
  },
  member_14: {
    ...
    specificTasks: [
      {
        taskName: "Molecular Cloning",
        description: "Performed vector construction, transformation, and other core experimental operations to support the project's molecular-level design and validation."
      },
      {
        taskName: "Protein Expression",
        description: "Conducted induction and expression experiments for target proteins, optimizing conditions to enhance expression efficiency and lay the foundation for functional analysis."
      },
      {
        taskName: "Data Documentation",
        description: "Assisted in organizing and summarizing experimental processes and results, ensuring the accuracy and traceability of data to improve the overall quality of project reports."
      }
    ]
  },
  member_15: {
    ...
    specificTasks: [
      {
        taskName: "Human Practice",
        description: "Focused on cooperation and inclusion in human practice. Promoted cooperation among team members, built an inclusive team atmosphere. Carried out activities to enhance team cohesion and cooperation ability, and promoted the harmonious development of the project team."
      }
    ]
  },
  member_16: {
    ...
    specificTasks: [
      {
        taskName: "Project Administration",
        description: "Responsible for the final product (solution) delivery of the project. Ensured the product met requirements, completed product testing, packaging, and handover to ensure successful delivery."
      },
      {
        taskName: "Investigation",
        description: "Deployed the solution in the actual environment, including environment configuration, system installation, etc. Solved problems in the deployment process to ensure the solution could work normally."
      },
      {
        taskName: "User Training",
        description: "Provided training for end-users, including writing instructions, conducting training sessions. Helped users master the use method of the solution to ensure effective application of the product."
      }
    ]
  },
  member_17: {
    ...
    specificTasks: [
      {
        taskName: "Safety",
        description: "Collaborated with Fang Wenlan in safety management work, including laboratory safety protocol implementation, data security measure execution, and ethical guideline compliance. Participated in safety inspection and management to ensure project safety."
      },
      {
        taskName: "Data Curation",
        description: "Assisted in wet experiments, carried out experimental operations, equipment maintenance, etc. Supported the smooth progress of the experiment, and cooperated with team members to complete experimental tasks."
      }
    ]
  },
  member_18: {
    ...
    specificTasks: [
      {
        taskName: "Investigation",
        description: "Responsible for complementary strand design. Conducted design work according to experimental needs, ensured design rationality and effectiveness, and provided support for experimental research."
      },
      {
        taskName: "Ethical Report Writing",
        description: "Wrote the project's ethical report, sorted out ethical issues in the project process, and explained how to follow ethical guidelines. Ensured the project's ethical compliance and provided a basis for project review."
      }
    ]
  },
  member_19: {
    ...
    specificTasks: [
      {
        taskName: "Analysis",
        description: "Conducted literature review related to the project, collected and analyzed relevant research results. Summarized research progress and trends to provide a reference for project research."
      },
      {
        taskName: "Writing",
        description: "Assisted in project result summary, sorted out experimental results, data analysis results, etc. Helped write project result reports to improve the comprehensiveness and clarity of results."
      }
    ]
  },
  member_20: {
    ...
    specificTasks: [
      {
        taskName: "Data Outreach & Visualization",
        description: "Develops and shares clear, compelling visualizations and summaries of dry lab results (e.g., computational models, simulations, bioinformatics analyses) for public audiences."
      },
      {
        taskName: "Online Platform Engagement",
        description: "Manages the presentation of dry lab work on project websites, wikis, and social media, ensuring content is accurate and accessible to both scientific and general communities."
      },
      {
        taskName: "Academic & Public Communication",
        description: "Facilitates discussions and knowledge exchange about the team's computational approaches at virtual conferences, public webinars, and with online collaborators."
      }
    ]
  },
  member_21: {
    ...
    specificTasks: [
      {
        taskName: "Record Keeping",
        description: "Oversee end-to-end Youtube content creation. From ideating video concepts (e.g., format, theme alignment with audience demand) to managing production (shooting, editing, adding subtitles/annotations), ensure outputs are engaging, high-quality, and fit platform algorithms."
      },
      {
        taskName: "Public Engagement",
        description: "Handle daily channel operations. Schedule and publish content timely, monitor comments to interact with viewers, update channel info/layout. Track data (views, watch time, subscriber trends) to guide content iteration."
      }
    ]
  },
  member_22: {
    ...
    specificTasks: [
      {
        taskName: "Wiki Coding",
        description: "Responsible for end-to-end wiki development and maintenance. From structuring content (e.g., layout design, information architecture) to implementing functional features (interactive elements, responsive UI), ensuring the wiki is user-friendly, visually coherent, and technically robust."
      },
      {
        taskName: "Web Development",
        description: "Handle the integration of front-end and back-end components. Optimize page performance and cross-browser compatibility, regularly update site content, and troubleshoot technical issues to ensure smooth and reliable wiki operation."
      }
    ]
  }
};
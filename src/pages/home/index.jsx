    ...
    <div className="home">
      ...
      <div className="home-body">
        <Routes>
          ...
          {/* 直接使用不带前缀的URL */}
          <Route path="/members" element={<PageWrapper headerImage="https://static.igem.wiki/teams/5822/newassets/titleimgs/merber.webp"><TeamMembers /><Bottom /></PageWrapper>} />
          ...
          <Route path="/description" element={<PageWrapper headerImage="https://static.igem.wiki/teams/5822/newassets/titleimgs/description1.webp"><ProjectDescription /><Bottom /></PageWrapper>} />
          <Route path="/engineering" element={<PageWrapper headerImage="https://static.igem.wiki/teams/5822/newassets/titleimgs/engineering-1.webp"><Engineering /><Bottom /></PageWrapper>} />
          ...
          <Route path="/development" element={<PageWrapper headerImage="https://static.igem.wiki/teams/5822/newassets/titleimgs/development-1.webp"><Development /><Bottom /></PageWrapper>} />
          <Route path="/experiments" element={<PageWrapper headerImage="https://static.igem.wiki/teams/5822/newassets/titleimgs/experjents.webp"><Experiments /><Bottom /></PageWrapper>} />
          <Route path="/notebook" element={<PageWrapper headerImage="https://static.igem.wiki/teams/5822/newassets/titleimgs/notebook.webp"><Notebook /><Bottom /></PageWrapper>} />
          <Route path="/parts" element={<PageWrapper headerImage="https://static.igem.wiki/teams/5822/newassets/titleimgs/parts.webp"><Part /><Bottom /></PageWrapper>} />
          <Route path="/safety" element={<PageWrapper headerImage="https://static.igem.wiki/teams/5822/newassets/titleimgs/safety.webp"><WetLabSafety /><Bottom /></PageWrapper>} />
          <Route path="/results" element={<PageWrapper headerImage="https://static.igem.wiki/teams/5822/newassets/titleimgs/results.webp"><Results /><Bottom /></PageWrapper>} />
          ...
          <Route path="/integrated-human-practices" element={<PageWrapper headerImage="https://static.igem.wiki/teams/5822/newassets/titleimgs/ihp-1.webp"><IHP /><Bottom /></PageWrapper>} />
